...
int main() {
    ...
    axes[0, 0].fill_between({.x = x, .y1 = y1, .y2 = y2, .alpha = 0.3, .color = "purple"});
    ...
    axes[0, 1].fill_between({.x = x, .y1 = y1, .y2 = 0.0, .alpha = 0.3, .color = "blue"});
    ...
    axes[1, 0].fill_between({.x = x, .y1 = y1, .y2 = y2, .where = y1 > y2, .alpha = 0.3, .color = "green", .label = "sin > cos"});
    axes[1, 0].fill_between({.x = x, .y1 = y1, .y2 = y2, .where = y1 < y2, .alpha = 0.3, .color = "red", .label = "cos < sin"});
